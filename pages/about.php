            ...
            <div class="col-lg-6 col-12">
              <div class="content section-headings">
                ...
                <h2
                  ...
                  data-aos="fade-up"
                >
                  Tanzania's Business Growth &amp; Investment Partner
                </h2>
                <div
                  class="text text-18"
                  data-aos="fade-up"
                >
                  Joint Group is a dynamic business growth and investment facilitation company based in Dar es Salaam, Tanzania. We serve as the strategic bridge between Tanzanian enterprises and the global investment community.
                </div>
                <ul class="text-lists list-unstyled">
                  ...
                  >
                    ...
                    Research-driven strategies that deliver measurable results
                  </li>
                  <li
                    class="text-item text text-18"
                    data-aos="fade-up"
                  >
                    ...
                    End-to-end support from consultancy to investor connections
                  </li>
                  <li
                    class="text-item text text-18"
                    data-aos="fade-up"
                  >
                    ...
                    Connecting Tanzanian enterprises with global investors
                  </li>
                </ul>
              ...
              <div class="col-12 col-lg-6">
                <div class="choose-us-content section-headings">
                  ...
                  <div class="choose-logo">
                    <div
                      class="choose-rotating-logo svg-wrapper"
                      data-aos="zoom-in-up"
                    >
                      <svg
                  ...
                  <div class="card-icon-text card-icon-text-horizontal">
                    ...
                    <div class="content">
                      ...
                      <p class="text text-16">
                        To accelerate business growth through innovative marketing, professional consultancy, human capital development, and international investment facilitation.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div class="card-icon-text card-icon-text-horizontal">
                    ...
                    <div class="content">
                      ...
                      <p class="text text-16">
                        To be the leading business growth and investment facilitation firm in Tanzania and East Africa.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div class="card-icon-text card-icon-text-horizontal">
                    ...
                    <div class="content">
                      ...
                      <p class="text text-16">
                        Integrity, innovation, and impact. We are committed to delivering measurable results that transform businesses and communities across East Africa.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-team radius18">
                    ...
                    <div class="card-team-content-absolute">
                      <div class="card-team-content">
                        <a href="#" aria-label="team details" class="heading text-22 fw-600">Ronald Richards</a>
...
<!-- Mirrored from consulo-html.vercel.app/html/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jun 2026 11:30:41 GMT -->
</html>
