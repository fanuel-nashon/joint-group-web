    ...
    <main>
                  ...
                  <div class="container height-100 d-flex align-items-center">
                    <div class="content-box slider-animation section-headings">
                      <div class="subheading text-20 subheading-bg">
                        ...
                        <span>Welcome to Joint Group</span>
                        <svg class="icon icon-14" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                  ...
                  <div class="container height-100 d-flex align-items-center">
                    <div class="content-box slider-animation section-headings">
                      <div class="subheading text-20 subheading-bg">
                        ...
                        <span>Welcome to Joint Group</span>
                        <svg class="icon icon-14" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                          <g clip-path="url(#clip0_9088_41433)">
                            <path d="M8.71401 5.28599C11.7514 5.4205 14 5.9412 14 7C14 8.0588 11.7514 8.5795 8.71401 8.71401C8.5795 11.7514 8.0588 14 7 14C5.9412 14 5.4205 11.7514 5.28599 8.71401C2.2486 8.5795 -1.33117e-07 8.0588 0 7C4.62818e-08 5.94119 2.2486 5.4205 5.28599 5.28599C5.4205 2.2486 5.9412 0 7 0C8.0588 0 8.5795 2.2486 8.71401 5.28599Z" fill="CurrentColor" />
                          </g>
                          <defs>
                            <clipPath>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-12">
              <div class="content section-headings">
                ...
                <h2 class="heading text-50" data-aos="fade-up"> Tanzania's Business Growth &amp; Investment Partner </h2>
                <div class="text text-18" data-aos="fade-up"> Joint Group is a Tanzania-based business growth and investment facilitation firm committed to empowering businesses through research-driven strategies, market intelligence, capacity building, and investor connections. </div>
                <ul class="text-lists list-unstyled">
                  <li class="text-item text text-18" data-aos="fade-up">
                    ...
                    </svg> Strategic bridge between Tanzanian enterprises and global investors
                  </li>
                  <li class="text-item text text-18" data-aos="fade-up">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                      <g clip-path="url(#clip0_9088_5324)">
                    ...
                    </svg> Research-driven strategies that deliver measurable results
                  </li>
                  <li class="text-item text text-18" data-aos="fade-up">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                      <g clip-path="url(#clip0_9088_5324)">
                    ...
                    </svg> End-to-end support from consultancy to investor connections
                  </li>
                </ul>
      ...
      <div class="multicolumn mt-100 section-padding">
        <div class="media media-bg">
          <img src="../assets/img/contact/contact-bg.jpg" width="1920" height="883" loading="lazy" alt="Background image">
        </div>
        <div class="container">
          <div class="multicolumn-header section-headings">
            ...
            <h2 class="heading text-50" data-aos="fade-up"> Comprehensive Solutions for Business Growth </h2>
          </div>
          <div class="multicolumn-inner">
            <div class="row">
              <div class="col-lg-4 col-12 multi-col" data-aos="fade-up">
                <a class="multicolumn-card" href="#" aria-label="View Service Details">
                  <div class="card-icon">
                  ...
                  <h2 class="heading text-28">Business Growth Consultancy</h2>
                  <div class="text text-16"> Helping businesses navigate market challenges with structured strategies and expert guidance. </div>
                  <ul class="text-lists list-unstyled">
              ...
              <div class="col-lg-4 col-12 multi-col" data-aos="fade-up" data-aos-delay="300">
                <a class="multicolumn-card" href="#" aria-label="View Service Details">
                  ...
                  <h2 class="heading text-28">Professional Training &amp; Development</h2>
                  <div class="text text-16"> Equipping professionals and organizations with the skills and capabilities to compete and grow. </div>
                  <ul class="text-lists list-unstyled">
                    <li class="text-item text text-16 fw-500">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M18 13H13V18C13 18.2652 12.8946 18.5196 12.7071 18.7071C12.5196 18.8946 12.2652 19 12 19C11.7348 19 11.4804 18.8946 11.2929 18.7071C11.1054 18.5196 11 18.2652 11 18V13H6C5.73478 13 5.48043 12.8946 5.29289 12.7071C5.10536 12.5196 5 12.2652 5 12C5 11.7348 5.10536 11.4804 5.29289 11.2929C5.48043 11.1054 5.73478 11 6 11H11V6C11 5.73478 11.1054 5.48043 11.2929 5.29289C11.4804 5.10536 11.7348 5 12 5C12.2652 5 12.5196 5.10536 12.7071 5.29289C12.8946 5.48043 13 5.73478 13 6V11H18C18.2652 11 18.5196 11.1054 18.7071 11.2929C18.8946 11.4804 19 11.7348 19 12C19 12.2652 18.8946 12.5196 18.7071 12.7071C18.5196 12.8946 18.2652 13 18 13Z" fill="CurrentColor" />
                      </svg> Corporate Training Programs
                    </li>
                    <li class="text-item text text-16 fw-500">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M18 13H13V18C13 18.2652 12.8946 18.5196 12.7071 18.7071C12.5196 18.8946 12.2652 19 12 19C11.7348 19 11.4804 18.8946 11.2929 18.7071C11.1054 18.5196 11 18.2652 11 18V13H6C5.73478 13 5.48043 12.8946 5.29289 12.7071C5.10536 12.5196 5 12.2652 5 12C5 11.7348 5.10536 11.4804 5.29289 11.2929C5.48043 11.1054 5.73478 11 6 11H11V6C11 5.73478 11.1054 5.48043 11.2929 5.29289C11.4804 5.10536 11.7348 5 12 5C12.2652 5 12.5196 5.10536 12.7071 5.29289C12.8946 5.48043 13 5.73478 13 6V11H18C18.2652 11 18.5196 11.1054 18.7071 11.2929C18.8946 11.4804 19 11.7348 19 12C19 12.2652 18.8946 12.5196 18.7071 12.7071C18.5196 12.8946 18.2652 13 18 13Z" fill="CurrentColor" />
                      </svg> Leadership Development
                    </li>
                    <li class="text-item text text-16 fw-500">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M18 13H13V18C13 18.2652 12.8946 18.5196 12.7071 18.7071C12.5196 18.8946 12.2652 19 12 19C11.7348 19 11.4804 18.8946 11.2929 18.7071C11.1054 18.5196 11 18.2652 11 18V13H6C5.73478 13 5.48043 12.8946 5.29289 12.7071C5.10536 12.5196 5 12.2652 5 12C5 11.7348 5.10536 11.4804 5.29289 11.2929C5.48043 11.1054 5.73478 11 6 11H11V6C11 5.73478 11.1054 5.48043 11.2929 5.29289C11.4804 5.10536 11.7348 5 12 5C12.2652 5 12.5196 5.10536 12.7071 5.29289C12.8946 5.48043 13 5.73478 13 6V11H18C18.2652 11 18.5196 11.1054 18.7071 11.2929C18.8946 11.4804 19 11.7348 19 12C19 12.2652 18.8946 12.5196 18.7071 12.7071C18.5196 12.8946 18.2652 13 18 13Z" fill="CurrentColor" />
                      </svg> Skills Gap Analysis
                    </li>
                  </ul>
                </a>
              </div>
        ...
        <div class="container">
          <div class="section-headings section-headings-horizontal">
            <div class="section-headings-left">
              ...
              <h2 class="heading text-50" data-aos="fade-right"> Explore the Recent Works We Have Done! </h2>
            </div>
            <div class="section-headings-right text text-18" data-aos="fade-left"> The solar solution company specializes in providing innovative, eco-friendly energy systems harness the power, reducing carbon footprints and energy for clients worldwide. </div>
          </div>
              ...
              <div class="col-lg-8 col-12">
                <div class="project-img-large">
                  <div class="project-img radius18" data-aos="zoom-in-up">
                    <img src="../assets/img/project/1.jpg" width="1000" height="595" loading="lazy" alt="Image">
                  </div>
                  <a href="#" class="project-media-button button button--primary" data-aos="zoom-in-up" aria-label="project-button">
                    <svg class="icon-28" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                      <path d="M15.1663 22.1641L23.333 13.9974M23.333 13.9974L15.1663 5.83073M23.333 13.9974H4.66634" stroke="CurrentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </a>
                </div>
              </div>
                ...
                <div class="row project-img-small">
                  <div class="col-6">
                    <div class="project-img radius18" data-aos="fade-left">
                      <img src="../assets/img/project/2.jpg" width="500" height="385" loading="lazy" alt="Image">
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="project-img radius18" data-aos="fade-left" data-aos-delay="200">
                      <img src="../assets/img/project/3.jpg" width="500" height="385" loading="lazy" alt="Image">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="project-content radius18 section-headings" data-aos="fade-up">
            <h2 class="heading text-36" data-aos="fade-up" data-aos-delay="50"> Unlocking New Opportunities for Sustainable Growth </h2>
            <div class="text text-18" data-aos="fade-up" data-aos-delay="100"> The solar solution company specializes in providing innovative, eco-friendly energy systems harness the power. </div>
            <div class="project-button buttons" data-aos="fade-up" data-aos-delay="150">
              <a href="#" class="button button--secondary" aria-label="View All Details"> View All Details <span class="svg-wrapper">
                  <svg class="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.3365 7.84518L6.16435 15.0173L4.98584 13.8388L12.158 6.66667H5.83652V5H15.0032V14.1667H13.3365V7.84518Z" fill="CurrentColor" />
                  </svg>
                </span>
            ...
            <div class="row">
              <div class="col-lg-7 col-12">
                <div class="promtion-content section-headings">
                  ...
                  <h2 class="heading text-50" data-aos="fade-right" data-aos-delay="200"> Supporting Growth on a Global Scale </h2>
                  <div class="text text-18" data-aos="fade-right" data-aos-delay="200"> The solar solution company specializes in providing innovative, eco-friendly energy systems that harness the power, reducing carbon footprints and energy for clients worldwide. </div>
                  <ul class="promotion-lists list-unstyled">
                    <li class="promotion-item" data-aos="fade-up" data-aos-delay="10">
                      <div class="promotion-title">
                        ...
                        <div class="text text-18 fw-600"> 99% Winning <br>Guarantee </div>
                      </div>
                      <div class="promotion-text text text-16"> The solar solution company specializes innovative. </div>
                    </li>
                    <li class="promotion-item" data-aos="fade-up" data-aos-delay="50">
                      <div class="promotion-title">
                        ...
                        <div class="text text-18 fw-600"> Full Time <br>Support </div>
                      </div>
                      <div class="promotion-text text text-16"> The solar solution company specializes innovative. </div>
                    </li>
                  </ul>
                  <div class="buttons" data-aos="fade-up">
                    <a href="#" class="button button--secondary" aria-label="View All Details"> Discover More <span class="svg-wrapper">
                        <svg class="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M13.3365 7.84518L6.16435 15.0173L4.98584 13.8388L12.158 6.66667H5.83652V5H15.0032V14.1667H13.3365V7.84518Z" fill="CurrentColor" />
                        </svg>
                      </span>
              ...
              <div class="col-12 col-lg-6">
                <div class="contact-form-wrap">
                  <div class="contact-box-headings section-headings">
                    ...
                    <h2 class="heading text-50" data-aos="fade-up" data-aos-delay="50" data-aos-anchor=".contact-box"> Get free business consultation today </h2>
                    <p class="text text-18" data-aos="fade-up" data-aos-delay="80" data-aos-anchor=".contact-box"> Need help with a project, have a question about our work? have a question about our work? We're here to help you. </p>
                  </div>
                  <form action="#" class="form contact-form">
                    <div class="field w-half" data-aos="fade-right" data-aos-anchor=".contact-form-wrap">
                      <label for="ContactForm-name" class="visually-hidden"> Your Name </label>
                    ...
                    <div class="field w-half" data-aos="fade-left" data-aos-anchor=".contact-form-wrap">
                      <label for="ContactForm-email" class="visually-hidden"> Your Email </label>
                    ...
                    <div class="field" data-aos="fade-up" data-aos-anchor=".contact-form-wrap">
                      <label for="ContactForm-body" class="visually-hidden"> Write your message </label>
                      <textarea id="ContactForm-body" class="text text-16" rows="4" placeholder="Write your message*" name="message" required></textarea>
                    </div>
                    <div class="form-button" data-aos="fade-up" data-aos-anchor=".contact-form-wrap">
                      <button type="submit" class="button button--primary" aria-label="Request Free Consultation"> Request Free Consultation <span class="svg-wrapper">
                          <svg class="icon-20" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
